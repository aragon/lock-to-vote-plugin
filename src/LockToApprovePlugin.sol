    ...
    IMembership
{
    ...
    LockToApproveSettings public settings;

    /// @inheritdoc ILockToVoteBase
    ILockManager public lockManager;

    mapping(uint256 => ProposalApproval) proposals;
    ...
    function initialize(
        ...
        LockToApproveSettings calldata _pluginSettings,
    ...
    function supportsInterface(bytes4 _interfaceId)
        ...
        returns (bool)
    {
        return _interfaceId == type(IMembership).interfaceId || _interfaceId == type(ILockToVoteBase).interfaceId
            || _interfaceId == type(ILockToApprove).interfaceId || super.supportsInterface(_interfaceId);
    }
